...
function FirstNews({ news, authors}) {
    ...
    <Box sx={{ position: "relative" }}>
      { news[0] && (
        ...
        >
          ...
          >
            {formatDate(news[0].created_at).day}
          </Typography>
          <Typography variant="h5" component="h5" sx={{ color: "white" }}>
            {formatDate(news[0].created_at).month}
          </Typography>
          <ArrowDropDownIcon
            sx={{
              height: "4rem",
      ...
      <Box sx={{display: 'flex', flexDirection: 'column'}}>
        ...
        >
         ...
         >
           ...
           variant="body1"
           component="body1"
           sx={{ fontWeight: "700", marginTop: '2rem', borderBottom: 1, width: 'fit-content', borderWidth: 3}}
         >
           READ ARTICLE
         </Typography>
         </>
